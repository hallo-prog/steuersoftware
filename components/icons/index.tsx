...
export const ArchiveIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 8l4 3H9a2 2 0 100 4m0 0l3 3m-3-3h8m-8 0V9a2 2 0 012-2h6l2 2v8a2 2 0 01-2 2H9a2 2 0 01-2-2v-1" />
  </svg>
);
